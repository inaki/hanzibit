...
export function buildStudyGuideReading(
  ...
  if (level <= 1) {
    return {
      ...
      listeningEn: `The teacher asked, "How will you use ${english} today?" I said, "I want to use ${english} in one sentence first."`,
      ...
      phraseCandidates: [
        {
          zh: `老师说“${word}”很重要`,
          en: `${english} is important`,
        },
        {
          zh: `用${word}写一个短句`,
          en: `use ${english} in a short sentence`,
        },
      ],
  ...
  if (level <= 3) {
    return {
      ...
      listeningEn: `A classmate said, "I first saw ${english} in the textbook, and only later dared to use it myself." The teacher replied, "First understand it, then say it yourself. Good."`,
  ...
  return {
    ...
    listeningEn: `The teacher said, "When you hear ${english}, don't think only about the meaning. Also think about why it appears here." That reminder makes me pay more attention to context.`,
